package ua.ros.spring.hotel.exeption.exceptions;
...
public class Message {
    ...
    public static final String BOOKING_CREATE_ERROR = "Cannot create new booking";
    ...
    public static final String INCORRECT_SORTING_ORDER = "validation.error.sortingOrder.format";

    public static final String ACCOUNT_ISNT_EXIST= "validation.error.account.notExist";
    public static final String APARTMENT_ISNT_EXIST = "validation.error.apartment.notExist";
    public static final String BOOKING_ISNT_EXIST = "validation.error.booking.notExist";
    public static final String ORDER_ISNT_EXIST = "validation.error.order.notExist";

    public static final String APARTMENT_ISNT_AVAILABLE = "validation.error.apartment.unavailable";

    //------------------ Security exception constants ------------------------\\
    public static final String DONT_HAVE_PERMISSION = "security.dontHavePermission";
}
